...
const api: AiopsPreloadApi = {
  ...
  importTerminalFont: (srcAbsPath: string) => ipcRenderer.invoke('settings:import-terminal-font', srcAbsPath),
  listTerminalFonts: () => ipcRenderer.invoke('settings:list-terminal-fonts'),
  ...
  loadTerminalRecovery: () => ipcRenderer.invoke('terminal:recovery:load'),
  saveTerminalRecovery: (snapshot) => ipcRenderer.invoke('terminal:recovery:save', snapshot),
