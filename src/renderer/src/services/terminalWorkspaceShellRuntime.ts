...
import { copyTextToClipboard, readTextFromClipboard, type ClipboardTextReadResult } from '@/services/clipboardRuntime'
import type { TerminalPanel, useWorkspaceStore } from '@/stores/workspace'
import type { PanelDirection } from '@/services/terminalPanelRuntime'
