...
export const normalizeTerminalConfig = (source?: Partial<TerminalUserConfig>) => {
  ...
  const normalized: TerminalSettings = {
    ...
    sshAutoReconnect: incoming.sshAutoReconnect !== false,
    sshShellIntegration: incoming.sshShellIntegration !== false,
    restoreTerminalTabs: incoming.restoreTerminalTabs !== false,
    ...
    debugLogs: typeof incoming.debugLogs === 'boolean' ? incoming.debugLogs : defaultTerminalSettings.debugLogs
  }
