...
import { currentSqlStatement } from '@/services/databaseSqlEditorRuntime'
import {
...
import { DB_AI_PANE_DEFAULT_WIDTH, sqlConnectionRequiresSchema } from '@/services/databaseWorkspaceRuntime'
import type { DbAiPaneQuickPrompt, SqlConsoleContext } from '@/services/databaseWorkspaceTypes'
import type {
