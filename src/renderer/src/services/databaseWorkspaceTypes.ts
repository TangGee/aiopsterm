...
import type { DataMutationPlanState, DbFilter, DbSort, DirtyState, EditOp, ResultStatus } from '@/services/databaseGridRuntime'
...
export type DatabaseChartModalState = {
  open: boolean
  summary: import('@/services/databaseWorkspaceRuntime').DatabaseChartSummary | null
  error: string
}
