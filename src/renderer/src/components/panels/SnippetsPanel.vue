<template>
  <section class="snippets-panel-native">
    ...
    <SnippetsToolbar
      ...
      @back="workspace.selectedSnippetGroupUuid = null"
      @add-group="startAddGroup"
      @toggle-macro="toggleMacroRecording"
      @add-command="openAddCommand"
      @activate-search="activateSearch"
      @update:search-query="workspace.snippetSearchQuery = $event"
    ...
    <div class="snippets-list">
      ...
      <SnippetsList
        ...
        @select-group="workspace.selectedSnippetGroupUuid = $event"
