...
import type { TerminalKillResult, TerminalSessionInfo } from '@shared/contracts/terminalSessions'
...
type TerminalFitOptions = { scrollToBottom?: boolean; frames?: number; forceGeometry?: boolean }
...
export const useTerminalControlSurface = ({
  workspace,
  terminalViews,
...
const terminalBufferText = (view: TerminalControlSurfaceView, tailLines: number) => {
