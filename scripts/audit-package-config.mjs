...
const mustContain = [
  ...
  'extraResources:',
  'from: resources/product-telemetry-worker.js',
  'to: product-telemetry-worker.js',
  ...
  'from: resources/aiopsterm-agent-hook-v1.ps1',
  'to: aiopsterm-agent-hook-v1.ps1',
...
const codexPackagingRequirements = [
  ...
  { label: 'packaged telemetry worker audit', source: packagedAppAuditScript, text: "join(resourcesDir, 'product-telemetry-worker.js')" },
