...
The question-mark button next to each settings page title opens the detailed document for that page.

- [General Settings](general.md)
- [Terminal Settings](terminal.md)
- [Extension Settings](extensions.md)
