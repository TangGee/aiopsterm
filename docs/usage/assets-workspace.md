...
- Bastion management in the Assets workspace uses the same tree interaction model as host management: organization rows, bastion-scope folders, nested child folders, and assets share expand/collapse, filtering, and page selection behavior.
