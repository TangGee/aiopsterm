...
The integration is pinned to `@cline/sdk@0.0.59`, release commit `0b65506a2b2225d55e5cc827e8296c9b65ff81ef`. The dependency is consumed from npm, and its source is not copied into aiopsterm.
